...
simply the average of the numbers. The standard deviation is a statistic that tells you how tightly all the various data are clustered around the mean in a set of data. For example, what is the average age of the students in a class? How close are the ages? If all the students are the same age, the deviation is 0.
...
public class Exercise5_45 {
   public static void main(String[] args) {
      ...
      double mean, // Holds the mean, the standard deviation and user input
	deviation, 		
        number;	
