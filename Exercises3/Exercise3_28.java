...
public class Exercise3_28 {
   ...
   // Determine whether the second rectangle is inside thefirst.
   if    ((Math.pow(Math.pow(r2y - r1y, 2), .05) + r2Height / 2 <= r1Height / 2) && 
         (Math.pow(Math.pow(r2x - r1x, 2), .05) + r2Width / 2 <= r1Width / 2) && (r1Height / 2 + r2Height / 2 <= r1Height) && (r1Width / 2 + r2Width / 2 <= r1Width))   System.out.println("r2 is inside r1"); else if ((r1x + r1Width / 2 > r2x - r2Width))(r1y + r1Height / 2 > r2y - r2Height))
