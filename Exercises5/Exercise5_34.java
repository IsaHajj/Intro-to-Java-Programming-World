...
plays the scissor-rock-paper game. Revise the program to let the user continuously play until either the user or the computer wins more than two times than its opponent.
*/
    ...
    public static void main(String[] args) {
       ...
       do {
		 ...
		 System.out.println(" too, It is a draw");
	          ...
	          (user == 1 && computer == 0) || (user == 2 && computer == 1);
	          if (win) {
	      ...
	      // If either the user or the computer wins are less than or equal to 2 continue play.
