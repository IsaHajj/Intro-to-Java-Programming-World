...
public class Exercise3_13 {
   public static void main(String[] args) {
    ...
    double tax = 0;
    switch (status) {
    case 0: // Compute tax for single filters
            ...
            break;
    case 1: // Compute tax for married file jointly or qualifying widow
            tax += (income <= 16700) ? income * 0.10 : 16700 * 0.10;
            if (income > 16700)
                tax += (income <= 67900) ? (income - 16700) * 0.15 :
                (67900 - 16700) * 0.15;
            if (income > 67900) 
                tax += (income <= 137050) ? (income - 67900) *25 :
                (137050 - 67900) * 0.25;
            if (income > 137050)
    ...
    case 2: // Compute tax for married separately
            ...
            break;
    case 3: // Compute tax for head of house
